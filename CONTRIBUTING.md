...
Baseplate ships at v1.0.0-rc.2. This document says what is in-scope without a major bump, what requires one, and the content-zone boundary that keeps `git pull` from clobbering your work.
