...
This is Baseplate **v0.1.0** — the first build, designed inside Operating-Volume-Engineering v2.6 and passed through its gauntlet (traceability matrix + golden-session gate). CHANGELOG.md is the authoritative release history; this file and README derive their version from it.
