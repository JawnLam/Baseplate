...
- Not a product builder. The stack is the terminal artifact; Keel does not build the product.
...
| `_keel-engine/` | The canon + protocols: `00-START-HERE`, `01-THE-CANON`, `02-ELICITATION`, `03-SELECTION`, `04-GENERATION-STANDARDS`, `05-GATES`, `BOOTSTRAP-NEW-STACK` |
...
The four OVE content zones plus Keel's Grows-Through-Use Zone are declared in [`CONTRIBUTING.md`](CONTRIBUTING.md) § Content zones.
...
See [`VERSION.md`](VERSION.md). This is **v0.1.0** — first build; `CHANGELOG.md` is the authoritative release history.
