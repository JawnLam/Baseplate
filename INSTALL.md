...
```bash
git clone https://github.com/JawnLam/Baseplate.git ~/path/to/Baseplate-v1.1
cd ~/path/to/Baseplate-v1.1
...
The folder is named `Baseplate-v<major>.<minor>`. On a major.minor release, rename it to match (`mv Baseplate-v1.1 Baseplate-v1.2`); `CHANGELOG.md` announces the transition.
